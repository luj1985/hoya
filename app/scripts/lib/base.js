...
(function(window, document, undefined) {
    ...
    $(function() {
        ...
        //     var _la = $(this).attr('data-la'); // tw zh en

        //     $('.language > a.current').removeClass('current');
        //     $(this).addClass('current');

        //     $('[data-' + _la + ']').each(function() {
        //         $(this).removeClass('data-en data-tw data-zh');
        //         $('body').removeClass('data-en data-tw data-zh');
        //         !$(this).attr('data-tw') && $(this).attr('data-tw', HY.htmlEncode($(this).html()));
        //         $(this).html($(this).attr('data-' + _la)).addClass('data-' + _la);
        //         $('body').addClass('data-' + _la);
        //     });
        // });
    });
})(window, document);